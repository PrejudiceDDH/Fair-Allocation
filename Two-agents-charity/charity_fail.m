function [output, valuation, valuation_, assignment, loop] = charity_fail(m,range)

valuation_1 = randi(range, 1, m);
valuation_2 = randi(range, 1, m);
valuation = [valuation_1;valuation_2]';
