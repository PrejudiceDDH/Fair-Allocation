function [assignment, output, loop] = main_copy(m, valuation)
...
[valuation_1/sum1; valuation_2/sum2]'
...
while (stop == 0) && (loop < 100000)
    loop
    [bundle_1, bundle_2]
    
    data_11 = value_11/sum1;
    data_12 = value_12/sum1;
    data_21 = value_21/sum2;
    data_22 = value_22/sum2;
    data_all = data_11 + data_12 + data_21 + data_22
    data_self = data_11 + data_22
    data_other = data_12 + data_21
